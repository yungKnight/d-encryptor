...
This is a python package for encrypting and decrypting texts using a drift cipher algorithm with an option for brute forcing decryptions in cases where the encryption drift might not be known.
